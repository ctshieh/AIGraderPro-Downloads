(function () {
  const dict = {
    zh: {
      hero_btn_download: "下載 macOS / Windows / Download",
...
nav_cap: "能力",
      ...
      hero_desc: "Local-first 的智慧閱卷與分析工具：步驟化評分、Rubric 拆解、批次 PDF 工作流與報告輸出。支援 macOS / Windows / Linux，並提供 11 種介面語言。",

      cap_title: "核心能力",
      wf_title: "工作流程",
      dl_title: "下載 / Download",
      ct_title: "聯絡",

      pr_title: "授權與定價",
      pr_sub: "年度授權方案，適合個人教師與教學團隊；作為介紹與銷售頁面可直接展示 Personal / Business 價格與 CTA。",
    ...
    en: {
      hero_btn_download: "Download macOS / Windows / 下載",
...
nav_cap: "Capabilities",
      ...
      hero_desc: "Local-first grading & analytics for educators: explainable scoring, rubric decomposition, batch PDF workflow, and exportable reports. Supports macOS / Windows / Linux and 11 UI languages.",

      cap_title: "Capabilities",
      wf_title: "Workflow",
      dl_title: "Download / 下載",
      ct_title: "Contact",

      pr_title: "Licensing & Pricing",
      pr_sub: "Annual licensing for individual educators and teaching teams. Personal / Business pricing can be shown directly on this intro + sales page.",
